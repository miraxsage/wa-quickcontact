...
function valid_config_or_null($config){
    ...
    $options_fields = ["mainLink", "mainAttrs",  "mainIcon", "pulseAnimation", "swingAnimation", "scrollInertia", "appearDelay", "appearDistance", "closeDelay", "side", "vertical", "excludePages"];
